...
from make_new_ac_6_2 import exec_gjf
...
def main_process(args):
    ...
    if not os.path.exists(auto_csv_path):        
        df_E = pd.DataFrame(columns = ['a','b','R3','R4','theta','A1','A2','A4','phi','E','E_p1','E_p2','E_t1','E_t2','E_t3','E_t4','machine_type','status','file_name'])
        df_E.to_csv(auto_csv_path,index=False)
...
def listen(args):
    ...
    fixed_param_keys = ['a','b','phi','theta','A1','A2','A4']
...
def get_opt_params_dict(df_cur, init_params_dict,fixed_params_dict):
    ...
    while True:
        ...
        if  R3_init==R3_init_prev and R4_init==R4_init_prev :
            ...
            R3_init_prev=R3_init
            R4_init_prev=R4_init
